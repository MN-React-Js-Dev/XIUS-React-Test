                    ...
                    <div className='row pt-5 pb-5'>
                        ...
                        <div className='col-sm-4 mb-4'>
                            <div className='cst-card-ims p-4'>
                                ...
                                <p>It helps you to stay connected no matter where you are. Whether you’re in the office, at home, or on the go, enjoy uninterrupted communication across multiple devices.</p>
                            </div>
                        </div>
                        <div className='col-sm-4 mb-4 pb-5'>
                            <div className='cst-card-ims p-4'>
                                <img src={VectorEightImage} className='img-fluid mb-4' />
                                <h2>Enhanced Quality and Reliability</h2>
                                <p>Experience crystal-clear voice calls, high-definition video conferencing, and lightning-fast data transfer with XIUS IMS. Say goodbye to dropped calls and lagging connections.</p>
                            </div>
                        </div>
                    </div>
                </div>
